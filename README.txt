# AI Homework 1 Programming

## Setup

You will need to install the openai gym and numpy in order to complete
the assignment. This assignment should work in 
python 3 or above.
...
integers. The `AI_hw1.lake_envs` contains variables to reference
these. For example:

```
print(AI_hw1.lake_envs.LEFT)
```
